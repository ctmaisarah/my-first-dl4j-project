...
public class ExDarkDataSetIterator_NewData {

    private static final Logger log = LoggerFactory.getLogger(ExDarkDataSetIterator_NewData.class);
    ...
    public static void setup() throws IOException {
        log.info("Load data...");
        loadData();
        trainDir = Paths.get(dataDir, "ExDark_NewData/Train");
        testDir = Paths.get(dataDir, "ExDark_NewData/Test");
    ...
    private static void loadData() throws IOException {
        ...
        downloadLink = "https://www.googleapis.com/drive/v3/files/1GBxjZcscuRjDrQK1mrvZ0VQD1VExLK3b?alt=media&key=AIzaSyB8YabIWgSWZYLO6Mb0F7d3Mxc9omqC2XE";
        File parentDir = new File(Paths.get(dataDir, "ExDark_NewData").toString());
        if (!parentDir.exists()) {
            downloadAndUnzip();
        }
    ...
    private static void downloadAndUnzip() throws IOException {
        ...
        File zipFile = new File(dataPath, "ExDark_NewData.zip");
        if (!zipFile.isFile()) {
