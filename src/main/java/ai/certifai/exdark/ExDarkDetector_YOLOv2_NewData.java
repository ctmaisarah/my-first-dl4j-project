...
public class ExDarkDetector_YOLOv2_NewData {

    private static final Logger log = LoggerFactory.getLogger(ExDarkDetector_YOLOv2_NewData.class);
    private static int seed = 123;
    private static double detectionThreshold = 0.5;
    private static int nBoxes = 4;
    private static double lambdaNoObj = 0.5; //default
    private static double lambdaCoord = 5.0; //default
    private static double[][] priorBoxes = {{3.6, 1.9}, {1, 2.7}, {2.3, 3.7}, {2, 2.5}}; //optimised priorBoxes
    ...
    private static File modelFilename = new File(System.getProperty("user.dir"), "generated-models/ExDarkDetector_YOLOv2_NewData.zip");
    ...
    public static void main(String[] args) throws Exception {
        ...
        ExDarkDataSetIterator_NewData.setup();
        RecordReaderDataSetIterator trainIter = ExDarkDataSetIterator_NewData.trainIterator(batchSize);
        RecordReaderDataSetIterator testIter = ExDarkDataSetIterator_NewData.testIterator(1);
...
//        If model does not exist, train the model, else directly go to model evaluation and then run real time object detection inference.
        if (modelFilename.exists()) {
            ...
            System.out.println(model.summary(InputType.convolutional(
                    ExDarkDataSetIterator_NewData.yoloheight,
                    ExDarkDataSetIterator_NewData.yolowidth,
                    nClasses)));
